...
::: {.fragment .fade-in}
[What inequality do you mean?]{.bubble .bubble-bottom-right .absolute top="20%" right="18%" style="--bubcol: var(--bubcol-red);"}
:::
...
- Austria: Stratified random sample from population register
- AT: approx. 6,000 households annually; EU: approx. 135,000 households (weights!)
...
::: columns
::: {.column width="49%" style="font-size:1.2rem"}
[**Individual level:**]{.red style="font-size:1.5rem"}
...
:::
::: {.column width="49%" style="font-size:1.2rem"}
[**Household level:**]{.red style="font-size:1.5rem"}
...
## Properties of inequality measures {.smaller}
