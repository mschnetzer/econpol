...
Please write a summary of the provided paper with a [**limit of 400 words**]{.marker-hl} and upload it on the [learning platform](https://learn.wu.ac.at). While assignments 1 [@piketty:2014] and 3 [@stockhammer:2013] are mandatory, students may choose between 2 [@milanovic:2015] and 4 [@atkinson:2014]. 
...
<br>
<i class="fa-solid fa-home icon"></i> Assignments: 30\% [(0-10 points for each homework)]{.grey600 style="font-size:2rem;"}
<br>
<br>

. . .

<i class="fa-solid fa-person-chalkboard icon"></i>  Poster presentation: 30\% [(0-20 points for the quality of the presentation, 0-10 for the poster style and structure)]{.grey600 style="font-size:2rem;"} 
<br>
<br>

. . .

<i class="fa-solid fa-file-pen icon"></i> Essay/Research proposal: 40\% [(0-30 points for the essay)]{.grey600 style="font-size:2rem;"}
